...
namespace Vekalat.Infrastructure.Data.Migrations.Migrations
{
    ...
    [Migration("20230409142739_add-equipment-item")]
    partial class addequipmentitem
    {
            ...
            modelBuilder.Entity("Vekalat.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "",
                            CreationTime = new DateTime(2023, 4, 9, 18, 57, 39, 226, DateTimeKind.Local).AddTicks(2271),
                            CreatorId = 1,
                        ...
                        new
                        {
                            Id = 2,
                            Address = "teh ",
                            CreationTime = new DateTime(2023, 4, 9, 18, 57, 39, 226, DateTimeKind.Local).AddTicks(2309),
            ...
            modelBuilder.Entity("Vekalat.Core.Entities.Blog", b =>
                {
                    b.HasOne("Vekalat.Core.Entities.BlogSubject", "BlogSubjectFk")
                        .WithOne("News")
                        .HasForeignKey("Vekalat.Core.Entities.Blog", "BlogSubjectId")
